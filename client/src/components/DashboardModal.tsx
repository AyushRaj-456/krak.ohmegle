    ...
    return (
        <div className="payment-modal-overlay">
            <div className="payment-modal relative" ref={modalRef} style={{ maxWidth: '600px' }}>
                <button className="close-btn z-50 absolute right-4 top-4 hover:bg-white/10 rounded-full p-2 transition-colors" onClick={onClose}>✕</button>
                ...
                {/* Guest Lock Overlay */}
                {profile.isGuest && (
                    <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-black/60 backdrop-blur-sm rounded-2xl animate-in fade-in">
                        <div className="bg-[#1a1a23] p-8 rounded-2xl border border-white/10 shadow-2xl text-center max-w-xs transform hover:scale-105 transition-transform duration-300">
                            ...
                            <button
                                onClick={onClose}
                                className="mt-6 px-6 py-2 bg-gradient-to-r from-gray-700 to-gray-600 hover:from-gray-600 hover:to-gray-500 text-white text-sm font-medium rounded-xl transition-all shadow-lg hover:shadow-xl border border-white/5 active:scale-95"
                            >
                                Close Dashboard
                            </button>
                        </div>
                ...
                <div className={`transition-all duration-300 ${profile.isGuest ? 'filter blur-sm opacity-80 pointer-events-none select-none grayscale-[0.3]' : ''}`}>
